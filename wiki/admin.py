...
from .models import Article, Category, Comment, Profile, UploadedFile, ArticleVote, CommentVote, UserVote
...
class ArticleAdmin(admin.ModelAdmin):
    list_display = ('title', 'category', 'author', 'allow_comments', 'created_at', 'updated_at')
